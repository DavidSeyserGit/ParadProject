...
protected:
    void init();
    enum CONTENT { DESERT, PLAIN , CITY , MILL , FIELD , OASIS , COIN, PLAYER, CAMEL, PUP};
    const char symbols[10] = {'~', ' ','H', static_cast<char>(207), static_cast<char>(178), static_cast<char>(254), '$', 'i', 'm', 'P'};
    const int colors[10] = {239, 32,32,32,46, 41, 224, 12, 230, 235};
